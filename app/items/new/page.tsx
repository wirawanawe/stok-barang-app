          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-8">
            ...
            <div className="border-t pt-8 flex justify-end space-x-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="px-8 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 disabled:opacity-50 flex items-center transition-all duration-200 shadow-lg hover:shadow-xl"
              >
                {loading ? (
                  <>
